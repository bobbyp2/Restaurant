...
<center>
	...
	<b><center><h2>Welcome to Add DETAILS</h2></center>
	<div class="container-fluid">
		<form autocomplete="off" action="EditProductController" method="post" style="margin-top: 2%; margin-right: 40%; margin-left: 10%;color:MediumSeaGreen;font-size:20px;">
