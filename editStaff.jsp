...
<form autocomplete="off" action="EditStaffController" method="post" style="margin-top:2%;margin-right:40%; margin-left:10%;">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="age" placeholder="Age"value="<%=staff.getAge()%>" required/>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="staffid" placeholder="Address"value="<%=staff.getStaff_id()%>"/>
  </div>
